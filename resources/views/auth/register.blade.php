    ...
    <nav class="bg-black bg-opacity-50 w-full py-4 fixed top-0 z-20">
        <div class="container mx-auto flex justify-between items-center px-6">
            ...
            <div class="flex space-x-6 text-white">
                ...
                <a class="hover:text-yellow-500" href="i">
                    Layanan
                </a>
            ...
            <div class="flex space-x-4">
                <a class=" bg-yellow-500 text-white font-bold py-2 px-4 rounded hover:bg-yellow-600" href="daftar.html">
                    Daftar
                </a>
                <a class=" text-white font-bold py-2 px-4 rounded hover:bg-yellow-600" href="{{ route('login') }}">
                    Masuk
                </a>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="name" id="name" placeholder="iksanming" type="name" />
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="email" id="email" placeholder="buditaufik@example.com" type="email" />
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                        PASSWORD
